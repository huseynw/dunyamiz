...
// Test üçün sabit player ID'leri
...
function getTimeRemaining(meetingDate, now) {
    const totalSeconds = Math.floor((meetingDate - now) / 1000);
    if (totalSeconds <= 0) {
...
exports.handler = async (event) => {
    try {
        ...
        // Son 3 saatda xatırlatma (saat, dəqiqə, saniyə ilə)
